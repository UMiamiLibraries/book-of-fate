...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { submission: @submission.submission, transcription_id: @submission.transcription_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { submission: @submission.submission, transcription_id: @submission.transcription_id } }
