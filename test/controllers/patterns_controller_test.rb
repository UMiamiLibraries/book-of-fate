...
class PatternsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pattern" do
    assert_difference('Pattern.count') do
      post patterns_url, params: { pattern: { offset: @pattern.offset, page: @pattern.page, pattern: @pattern.pattern, side: @pattern.side } }
    end
  ...
  test "should update pattern" do
    patch pattern_url(@pattern), params: { pattern: { offset: @pattern.offset, page: @pattern.page, pattern: @pattern.pattern, side: @pattern.side } }
